...
- [ ] T017 [P] Manual validation of the 6 acceptance scenarios in spec.md: digest ready, digest processing, automatic transition, digest failed, no digest yet, and history navigation/pagination. — unauthenticated-redirect behavior confirmed live; the content-bearing scenarios (1, 2, 3, 4, 5, 6) need a real login session, handed off to the requester.
