...
- [x] T026 [P] After merge, write an ADR (`docs/adrs/0004-*.md`) documenting the cron pipeline's idempotency and failure-isolation design, per this plan's Constitution Check note.
